...
public class AnalysisResultEntity {
    ...
    @Enumerated(EnumType.STRING)
    @Column(name = "volatility_label", nullable = false, length = 10)
    private VolatilityLabel volatilityLabel;
    ...
    public AnalysisResultEntity(UUID userId, Market market, String symbol, Instant entryAt, BigDecimal entryPrice,
            BigDecimal stopLossPrice, BigDecimal takeProfitPrice, BigDecimal positionPct, AnalyzeDirection direction,
            double trendScore, double volatilityScore, VolatilityLabel volatilityLabel, double locationScore,
        ...
        this.volatilityLabel = volatilityLabel;
